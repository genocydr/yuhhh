...
MAIN:
  ...
  NAMECALL R5 R5 K5 ["GetFastInt"]
  CALL R5 2 1
  DUPCLOSURE R6 K9 [PROTO_0]
  CAPTURE VAL R0
  SETTABLEKS R6 R1 K10 ["_sendToKibana"]
  LOADB R6 0
  SETGLOBAL R6 K11 ["ReportedOpen"]
  DUPCLOSURE R6 K12 [PROTO_1]
  CAPTURE VAL R2
  SETTABLEKS R6 R1 K13 ["reportOpen"]
  LOADB R6 0
  SETGLOBAL R6 K14 ["ReportedSelect"]
  DUPCLOSURE R6 K15 [PROTO_2]
  CAPTURE VAL R3
  SETTABLEKS R6 R1 K16 ["reportSelect"]
  DUPCLOSURE R6 K17 [PROTO_3]
  CAPTURE VAL R4
  SETTABLEKS R6 R1 K18 ["reportBreakdown"]
  DUPCLOSURE R6 K19 [PROTO_4]
  CAPTURE VAL R5
  SETTABLEKS R6 R1 K20 ["reportPermissionCheck"]
  RETURN R1 1
