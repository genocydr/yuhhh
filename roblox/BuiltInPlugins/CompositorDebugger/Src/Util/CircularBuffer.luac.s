...
MAIN:
  ...
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K3 ["clone"]
  DUPCLOSURE R1 K4 [PROTO_2]
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K5 ["clear"]
  DUPCLOSURE R1 K6 [PROTO_3]
  SETTABLEKS R1 R0 K7 ["getSize"]
  DUPCLOSURE R1 K8 [PROTO_4]
  SETTABLEKS R1 R0 K9 ["push"]
  DUPCLOSURE R1 K10 [PROTO_5]
  SETTABLEKS R1 R0 K11 ["__index"]
  DUPCLOSURE R1 K12 [PROTO_6]
  CAPTURE VAL R0
  SETTABLEKS R1 R0 K13 ["resize"]
  DUPCLOSURE R1 K14 [PROTO_7]
  SETTABLEKS R1 R0 K15 ["dump"]
  RETURN R0 1
