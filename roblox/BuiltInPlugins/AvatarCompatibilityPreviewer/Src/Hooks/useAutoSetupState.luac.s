...
PROTO_29:
  ...
  GETTABLE R4 R5 R3
  JUMPIFEQKNIL R4 [+24]
  GETTABLEKS R5 R4 K23 ["PrimaryPart"]
  JUMPIFEQKNIL R5 [+20]
  GETUPVAL R9 6
  GETTABLEKS R8 R9 K24 ["ATTRIBUTE_AUTO_SETUP_INPUT_ASSET"]
  NAMECALL R6 R4 K25 ["GetAttribute"]
  CALL R6 2 1
  ORK R5 R6 K9 [""]
  GETIMPORT R6 K28 [task.spawn]
  NEWCLOSURE R7 P0
  CAPTURE UPVAL U7
  CAPTURE UPVAL U8
  CAPTURE UPVAL U9
  ...
  CALL R6 1 0
  GETUPVAL R7 10
  GETTABLEKS R6 R7 K29 ["autoSetupClickedSignal"]
  JUMPIFEQKNIL R6 [+7]
  GETUPVAL R7 10
  GETTABLEKS R6 R7 K29 ["autoSetupClickedSignal"]
  NAMECALL R6 R6 K30 ["Fire"]
  CALL R6 1 0
  RETURN R0 0
...
PROTO_31:
  ...
  CALL R17 1 1
  GETUPVAL R19 2
  GETTABLEKS R18 R19 K4 ["useContext"]
  GETUPVAL R20 6
  GETTABLEKS R19 R20 K21 ["Context"]
  CALL R18 1 1
  GETUPVAL R20 2
  ...
  CAPTURE UPVAL U12
  NEWTABLE R21 0 3
  GETTABLEKS R22 R2 K22 ["startAutoSetupAsync"]
  GETTABLEKS R23 R2 K23 ["uploadModelAsync"]
  MOVE R24 R18
  SETLIST R21 R22 3 [1]
  CALL R19 2 1
  GETUPVAL R21 2
  ...
  NEWTABLE R22 0 0
  CALL R20 2 1
  DUPTABLE R21 K31 [{"cancelAutoSetup", "startAutoSetup", "activeTarget", "lastErrorType", "lastErrorTarget", "clearError", "progressState"}]
  SETTABLEKS R20 R21 K24 ["cancelAutoSetup"]
  SETTABLEKS R19 R21 K25 ["startAutoSetup"]
  SETTABLEKS R3 R21 K26 ["activeTarget"]
  SETTABLEKS R7 R21 K27 ["lastErrorType"]
  SETTABLEKS R9 R21 K28 ["lastErrorTarget"]
  SETTABLEKS R12 R21 K29 ["clearError"]
  SETTABLEKS R14 R21 K30 ["progressState"]
  RETURN R21 1
...
MAIN:
  ...
  GETTABLEKS R21 R22 K34 ["getFFlagAvatarPreviewerUseAnyModel"]
  CALL R20 1 1
  GETIMPORT R21 K11 [require]
  GETTABLEKS R24 R3 K12 ["Src"]
  GETTABLEKS R23 R24 K33 ["Flags"]
  GETTABLEKS R22 R23 K35 ["getFFlagDebugAvatarPreviewerSharedCache"]
  CALL R21 1 1
  GETIMPORT R22 K11 [require]
  GETTABLEKS R25 R3 K12 ["Src"]
  GETTABLEKS R24 R25 K33 ["Flags"]
  GETTABLEKS R23 R24 K36 ["getFFlagHumanoidModelScalingFix"]
  CALL R22 1 1
  GETIMPORT R23 K11 [require]
  GETTABLEKS R26 R3 K12 ["Src"]
  GETTABLEKS R25 R26 K33 ["Flags"]
  GETTABLEKS R24 R25 K37 ["getFFlagStudioAvatarAutosetupReportsProgress"]
  CALL R23 1 1
  GETIMPORT R24 K11 [require]
  GETTABLEKS R27 R3 K12 ["Src"]
  GETTABLEKS R26 R27 K15 ["Util"]
  GETTABLEKS R25 R26 K38 ["getRotationInXZPlane"]
  CALL R24 1 1
  DUPTABLE R25 K47 [{"Created", "Pending", "Processing", "Finalizing", "Completed", "Invalid", "Failed", "Canceled"}]
  LOADN R26 1
  SETTABLEKS R26 R25 K39 ["Created"]
  LOADN R26 2
  SETTABLEKS R26 R25 K40 ["Pending"]
  LOADN R26 3
  SETTABLEKS R26 R25 K41 ["Processing"]
  LOADN R26 4
  SETTABLEKS R26 R25 K42 ["Finalizing"]
  LOADN R26 5
  SETTABLEKS R26 R25 K43 ["Completed"]
  LOADN R26 101
  SETTABLEKS R26 R25 K44 ["Invalid"]
  LOADN R26 102
  SETTABLEKS R26 R25 K45 ["Failed"]
  LOADN R26 103
  SETTABLEKS R26 R25 K46 ["Canceled"]
  ...
  DUPCLOSURE R31 K53 [PROTO_7]
  CAPTURE VAL R7
  DUPCLOSURE R32 K54 [PROTO_12]
  CAPTURE VAL R31
  CAPTURE VAL R24
  CAPTURE VAL R7
  CAPTURE VAL R2
