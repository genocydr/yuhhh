...
PROTO_6:
  ...
  JUMPIFNOT R2 [+20]
  GETUPVAL R8 1
  GETTABLEKS R7 R8 K0 ["TranslationRoles"]
  GETTABLEKS R6 R7 K1 ["V1"]
  GETTABLEKS R5 R6 K2 ["GameLocalizationRoles"]
  GETTABLEKS R4 R5 K3 ["Games"]
  GETTABLEKS R3 R4 K4 ["CurrentUser"]
  GETTABLEKS R2 R3 K5 ["roles"]
  ...
  JUMP [+13]
  GETUPVAL R5 1
  GETTABLEKS R4 R5 K9 ["API"]
  GETTABLEKS R3 R4 K10 ["Loc"]
  GETTABLEKS R2 R3 K0 ["TranslationRoles"]
  GETIMPORT R4 K7 [game]
  GETTABLEKS R3 R4 K8 ["GameId"]
  CALL R2 1 1
  MOVE R1 R2
  ...
  CALL R2 -1 0
  NAMECALL R2 R1 K12 ["makeRequest"]
  CALL R2 1 1
  NEWCLOSURE R4 P0
  CAPTURE UPVAL U3
  CAPTURE VAL R0
...
MAIN:
  ...
  LOADK R7 K15 ["StudioPlat37699UnmoveCreatorInventoryItems"]
  LOADB R8 0
  NAMECALL R5 R5 K16 ["DefineFastFlag"]
  CALL R5 3 1
  DUPTABLE R6 K20 [{"owner", "collaborator", "translator"}]
  LOADB R7 1
  SETTABLEKS R7 R6 K17 ["owner"]
  LOADB R7 1
  SETTABLEKS R7 R6 K18 ["collaborator"]
  LOADB R7 1
  SETTABLEKS R7 R6 K19 ["translator"]
  ...
  CAPTURE VAL R1
  CAPTURE VAL R4
  DUPTABLE R12 K29 [{"GetAll", "OnGameIdChanged", "GetManageTranslationPermission"}]
  SETTABLEKS R11 R12 K26 ["GetAll"]
  SETTABLEKS R10 R12 K27 ["OnGameIdChanged"]
  SETTABLEKS R8 R12 K28 ["GetManageTranslationPermission"]
  RETURN R12 1
