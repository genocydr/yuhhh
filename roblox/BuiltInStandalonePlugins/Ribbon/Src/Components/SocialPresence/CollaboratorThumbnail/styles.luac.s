MAIN:
  ...
  GETTABLEKS R4 R5 K12 ["getFFlagLoginAvatarThumbnail"]
  CALL R3 1 1
  CALL R3 0 1
  ...
  JUMP [+1]
  LOADK R11 K38 [">> #Avatar"]
  DUPTABLE R12 K41 [{"AnchorPoint", "BorderSizePixel", "Position", "Size", "BackgroundColor3"}]
  LOADK R13 K20 ["$AnchorCenter"]
  SETTABLEKS R13 R12 K16 ["AnchorPoint"]
  LOADK R13 K42 ["$BorderNone"]
  SETTABLEKS R13 R12 K39 ["BorderSizePixel"]
  ...
  LOADK R13 K43 ["$SemanticColorComponentMediaFill"]
