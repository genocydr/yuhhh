...
PROTO_9:
  ...
  GETUPVAL R1 1
  GETUPVAL R3 2
  GETTABLEKS R2 R3 K1 ["Query"]
  CALL R1 1 0
  GETUPVAL R2 2
  GETTABLEKS R1 R2 K2 ["InitialContentHasLoaded"]
  LOADB R2 1
  CALL R1 1 0
  RETURN R0 0
...
PROTO_10:
  ...
  JUMP [+1]
  LOADNIL R24
  SETTABLEKS R24 R23 K33 ["Visible"]
  MOVE R24 R2
  CALL R24 0 1
  SETTABLEKS R24 R23 K18 ["LayoutOrder"]
  GETUPVAL R25 5
  ...
  DUPTABLE R27 K45 [{"Size", "DisplayComponent", "HasParentLoaded", "MaxCount", "Dropdowns", "OnItemCountUpdated", "InitialContentHasLoaded", "CellComponent", "CellSize", "CellPadding", "BaseQuery"}]
  GETUPVAL R29 6
  JUMPIFNOT R29 [+2]
  LOADNIL R28
  JUMP [+7]
  ...
  LOADNIL R28
  JUMP [+3]
  GETTABLEKS R29 R0 K46 ["AreSearchResultsLoading"]
  NOT R28 R29
  ...
  JUMP [+1]
  LOADNIL R28
  SETTABLEKS R28 R27 K39 ["OnItemCountUpdated"]
  GETUPVAL R29 3
  JUMPIFNOT R29 [+2]
  LOADNIL R28
  JUMP [+4]
  ...
  CAPTURE REF R6
  CAPTURE VAL R0
  SETTABLEKS R28 R27 K40 ["InitialContentHasLoaded"]
  GETUPVAL R28 8
  SETTABLEKS R28 R27 K41 ["CellComponent"]
  GETIMPORT R28 K10 [UDim2.new]
  LOADN R29 1
  LOADN R30 0
  LOADN R31 0
  LOADN R32 90
  CALL R28 4 1
  SETTABLEKS R28 R27 K42 ["CellSize"]
  GETIMPORT R28 K10 [UDim2.new]
  LOADN R29 0
  LOADN R30 0
  LOADN R31 0
  LOADN R32 0
  CALL R28 4 1
  SETTABLEKS R28 R27 K43 ["CellPadding"]
  GETUPVAL R28 9
  GETTABLEKS R29 R0 K44 ["BaseQuery"]
  DUPTABLE R30 K48 [{"search"}]
  GETTABLEKS R31 R0 K11 ["Query"]
  SETTABLEKS R31 R30 K47 ["search"]
  CALL R28 2 1
  SETTABLEKS R28 R27 K44 ["BaseQuery"]
  CALL R25 2 -1
  SETLIST R24 R25 -1 [1]
  CALL R21 3 1
  JUMP [+1]
  ...
  LOADK R27 K50 ["SeeAllMatchingExperiences"]
  NAMECALL R24 R1 K25 ["getText"]
  CALL R24 3 1
  SETTABLEKS R24 R23 K26 ["Text"]
  GETUPVAL R26 5
  GETTABLEKS R25 R26 K51 ["Event"]
  GETTABLEKS R24 R25 K52 ["Activated"]
  GETTABLEKS R25 R0 K53 ["MoreExperiencesRequested"]
  SETTABLE R25 R23 R24
  GETUPVAL R26 5
  GETTABLEKS R25 R26 K51 ["Event"]
  ...
  GETUPVAL R25 5
  GETTABLEKS R24 R25 K6 ["Tag"]
  LOADK R25 K56 ["X-Fit X-Pad X-Transparent StartPage-Font StartPage-LinkTextColor StartPage-TextSize"]
  SETTABLE R25 R23 R24
  CALL R21 2 1
